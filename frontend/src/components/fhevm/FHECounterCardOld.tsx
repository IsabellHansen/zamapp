...
import { useFHECounterSimple } from '../../hooks/useFHECounterSimple';
...
const FHECounterCard: React.FC = () => {
  ...
  const fheCounter = useFHECounterSimple({ chainId });
    ...
    <div className="card fhe-counter-card">
      ...
      <div className="encrypted-display">
        ...
        <div className="encrypted-value">
          {fheCounter.handle ? (
            <code className="encrypted-hash">{fheCounter.handle}</code>
          ) : (
